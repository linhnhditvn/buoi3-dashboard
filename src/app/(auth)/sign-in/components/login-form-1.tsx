...
export function LoginForm1({
  ...
  async function handleGoogleSignIn() {
    try {
      ...
      form.setError("root", {
        message: getFirebaseAuthErrorMessage(error, "signin"),
      })
    } finally {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <div className="grid gap-6">
                <div className="grid gap-4">
                  ...
                  <Button variant="outline" className="w-full cursor-pointer" type="button" onClick={handleGoogleSignIn} disabled={googleLoading}>
                    {googleLoading ? (
                      <>
