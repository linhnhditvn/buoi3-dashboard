...
- **Lưu dữ liệu vào firebase/ filestorage** khi hoàn thành tính năng.
...
1. Thao tác xóa hiển thị confirmation dialog trước khi xóa, dùng shadcn/ui dialog component.